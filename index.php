<html>
<head>
	<title>CDPR Health Care Management </title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>CDPR Health Care</h4></a>
...
<a href="cdpr.png">
  <img src="cdpr.png" alt="cdprhealthcare" />
</a>
<h3>Welcome</h3>
                    </div>
