...
-- --------------------------------------------------------
--
-- Table structure for table `nurstb`
--
...
-- Dumping data for table `nurstb`
--

INSERT INTO `nurstb` (`username`, `password`, `email`, `spec`, `docFees`) VALUES
('merina', 'merina123', 'merina@gmail.com', 'General', ),
-----------------------------------------------------------
