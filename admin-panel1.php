...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> CDPR Health Care Management </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #074b10ff, #0aa342ff);
}
...
.list-group-item.active {
    z-index: 2;
    color: #fff;
    background-color: #2c990bff;
    border-color: #0d3f15ee;
}
.text-primary {
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-nurstb" id="list-nurstb-list"  role="tab" data-toggle="list" aria-controls="list">Nurse List</a>
